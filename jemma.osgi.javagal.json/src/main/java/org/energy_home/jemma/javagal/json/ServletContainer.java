...
import org.energy_home.jemma.javagal.json.servlet.interpanServlet;
...
public class ServletContainer implements HttpSessionListener{
	...
	private void registerServlets() {
		try {
			...
			/*
			 * Defines LocalServices route "json/net/default/localnode/services"
			 */
			...
			/*
			 * Defines InfoBase route "json/net/default/ib"
			 */
			...
			/*
			 * Defines route "json/wakeuponlan"
			 */
			service.registerServlet(prefix + "/wakeuponlan", new wakeUpOnLanServlet(), null, null);
			
			/*
			 * Defines route "json/net/default/interpan"
			 */
			service.registerServlet(prefix + Resources.NWT_ROOT_URI + ResourcePathURIs.INTERPAN, new interpanServlet(gatewayInterface), null, null);
	...
	public void unregister() {
		...
		/*
		 * Defines InfoBaseAttribute route "json/net/default/ib"
		 */
		 ...
		 * Defines  route "/json/net/default/interpan"
		 */
		service.unregister(prefix + Resources.NWT_ROOT_URI + ResourcePathURIs.INTERPAN);
